import websiteImg2 from "../assets/download (3).jpg";
...
export default function Projects() {
  const config = {
    projects: [
      {
        image: websiteImg2,
        description: "Basic Book Store website,Built with React Freamwork",
        link: "https://book-forntend-rho.vercel.app/",
      },
      {
        image: websiteImg3,
        description: "Basic Blog Website . Built with Next JS and MongoDB",
        link: "https://blog-forntend.vercel.app/",
      },
    ],
  };
